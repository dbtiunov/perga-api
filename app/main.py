...
from app.api.v1 import planner_days, planner_agendas, auth, notes, notes_folders
...
app.include_router(notes_folders.router, prefix=f"{settings.API_V1_STR}/notes/folders", tags=["notes_folders"])
